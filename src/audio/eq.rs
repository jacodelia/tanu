...
/// The original Winamp EQ presets, cloned from
/// github.com/schollz/Winamp-Original-Presets. Winamp stores each band as a
/// 0–64 slider (33 = 0 dB, ±12 dB range), converted here to dB via
/// `(value - 33) * 12/32`. Bands: 70/180/320/600/1k/3k/6k/12k/14k/16k Hz.
